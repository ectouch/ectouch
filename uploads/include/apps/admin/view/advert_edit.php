      ...
      <table id="general-table" class="table table-hover ectouch-table">
        ...
        <tr>
          ...
          <td><div class="col-md-3">
              <input type='text' name='data[ad_width]' maxlength="100" value="{$info['ad_width']}" class="form-control input-sm" />{$lang['px']}
            </div></td>
        </tr>
        <tr>
          <td>{$lang['ad_height']}</td>
          <td><div class="col-md-3">
              <input type='text' name='data[ad_height]' maxlength="100" value="{$info['ad_height']}" class="form-control input-sm" />{$lang['px']}
            </div>
          </td>
        </tr>
        <tr>
