...
<table class="table table-hover ectouch-table">
    ...
    <tr>
        <td width="200">等级积分值</td>
        <td>
            <div class="col-md-4 col-sm-4">
                <input type="text" name="cfg_value[rank_point_value]" class="form-control" value="{$config['config']['rank_point_value']}" />
           </div>
        </td>
    </tr>
    <tr>
        <td width="200">消费积分值</td>
        <td>
            <div class="col-md-4 col-sm-4">
                <input type="text" name="cfg_value[pay_point_value]" class="form-control" value="{$config['config']['pay_point_value']}" />
           </div>
        </td>
    </tr>
   <tr>
